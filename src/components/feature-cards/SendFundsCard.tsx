...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Быстрое пополнение</h3>
      <p className="mb-4 text-sm text-gray-400">Пополняйте карту из России за минуты — переводом, картой или через СБП</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">Баланс карты (USD)</p>
              <p className="text-xs text-gray-500">Доступно: $372,00</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Автопополнение при низком балансе</span>
        </div>
      </div>
    </div>
  )
